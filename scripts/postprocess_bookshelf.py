...
css_marker = "/* TANGTHU_BOOKSHELF_V5 */"
css = r'''
/* TANGTHU_BOOKSHELF_V5 */
.shelf-view{padding:12px;background:#fff;min-height:100%}
.shelf-row{position:relative;margin:0 0 18px;padding:8px 12px 40px;min-height:220px;box-sizing:border-box;background-color:#c0c0c0;background-image:url('assets/bookshelf/shelf-row.png');background-repeat:repeat-x;background-position:left bottom;background-size:auto 34px}
...
.shelf-book-name{position:absolute;left:14px;right:14px;top:82px;margin:0;padding:0;text-align:center;font-weight:bold;font-size:13px;line-height:1.12;color:#fff;background:transparent!important;border:0!important;box-shadow:none!important;text-shadow:1px 1px 0 #000,-1px -1px 0 #000,1px -1px 0 #000,-1px 1px 0 #000;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;overflow:hidden;min-height:0;z-index:2}
...
@media(max-width:1050px){
  ...
  .shelf-book-name{left:13px;right:13px;top:76px;font-size:12px}
}
@media(max-width:760px){
  ...
  .shelf-book-name{left:12px;right:12px;top:62px;font-size:11px}
...
@media(max-width:500px){
  ...
  .shelf-book-name{left:10px;right:10px;top:58px;font-size:10px}
}
'''
